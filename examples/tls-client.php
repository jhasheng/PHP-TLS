...
while (true) {
    ...
    $debug = $tls->getDebug();
    // echo $debug->getProtocolVersion();
    // echo $debug->getCertificates();
    // echo $debug->getPrivateKey();
    // echo $debug->getUsingCipherSuite();
    // echo $debug->getSessionID();
    // echo $debug->getMasterSecret();
